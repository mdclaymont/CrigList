...
public class TestBase {
	...
	* ***************************************************************************************************************/
	...
	public static WebDriver initilizeDriver() throws IOException {
		...
		if(DriverPath.isEmpty()||DriverPath.isBlank()|| DriverPath.length()<1)//if user does not provided driver path default will look from current directory 
		{
			AcDriverPath=CurrentPath;
			//AcDriverPath=CurrentPath.substring(0, CurrentPath.length());
		}
		else
		{//if user Provided Path then	 
			AcDriverPath=DriverPath;
		...
		{
			//C:\Users\nyc\git\repository\MavenCrig\Driver\chromedriver.exe
